...
import { sendWebHookMSG } from "./sendWebhookMSG.js";
import axios from "axios";
const webSocketURL = "wss://ws-us2.pusher.com/app/32cbd69e4b950bf97679?protocol=7&client=js&version=8.4.0&flash=false";
const chatroomId = 6255205;
const channel = `chatrooms.${chatroomId}.v2`;
let usersTryingToRedeem = [];
export async function getCooldown() {
    const SSURL = "https://web.kick.com/api/v1/channels/6302286/chat/settings";
